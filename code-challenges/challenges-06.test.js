...
Use the snippet as your guide for creating your templates. Return an array of template strings. Note: this function does not need to 
actually append the markup to the DOM.
------------------------------------------------------------------------------------------------ */
let characters = [
  {
    name: 'Eddard',
...
const templatingWithMustache = () => {
  ...
  characters.forEach(obj =>{
    ...
    text.push(Mustache.render(temp, obj));
  });
  return text;
};
